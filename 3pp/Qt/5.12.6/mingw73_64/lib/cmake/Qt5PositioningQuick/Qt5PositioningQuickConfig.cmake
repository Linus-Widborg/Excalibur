...
set(Qt5PositioningQuick_VERSION_STRING 5.12.6)
...
macro(_populate_PositioningQuick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::PositioningQuick PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5PositioningQuick_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5PositioningQuick_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::PositioningQuick)
    ...
    set(Qt5PositioningQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5PositioningQuick_install_prefix}/include/QtPositioningQuick/5.12.6"
        "${_qt5PositioningQuick_install_prefix}/include/QtPositioningQuick/5.12.6/QtPositioningQuick"
    )
    ...
    foreach(_module_dep ${_Qt5PositioningQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.6 ${_Qt5PositioningQuick_FIND_VERSION_EXACT}
    ...
    _populate_PositioningQuick_target_properties(RELEASE "Qt5PositioningQuick.dll" "libQt5PositioningQuick.a" )



    _populate_PositioningQuick_target_properties(DEBUG "Qt5PositioningQuickd.dll" "libQt5PositioningQuickd.a" )
