...
set(Qt5Purchasing_VERSION_STRING 5.12.6)
...
if (NOT TARGET Qt5::Purchasing)
    ...
    set(Qt5Purchasing_PRIVATE_INCLUDE_DIRS
        "${_qt5Purchasing_install_prefix}/include/QtPurchasing/5.12.6"
        "${_qt5Purchasing_install_prefix}/include/QtPurchasing/5.12.6/QtPurchasing"
    )
    ...
    foreach(_module_dep ${_Qt5Purchasing_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.6 ${_Qt5Purchasing_FIND_VERSION_EXACT}
    ...
    _populate_Purchasing_target_properties(RELEASE "Qt5Purchasing.dll" "libQt5Purchasing.a" )



    _populate_Purchasing_target_properties(DEBUG "Qt5Purchasingd.dll" "libQt5Purchasingd.a" )
