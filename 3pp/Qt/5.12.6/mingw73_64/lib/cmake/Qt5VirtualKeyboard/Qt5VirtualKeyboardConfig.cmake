...
set(Qt5VirtualKeyboard_VERSION_STRING 5.12.6)
...
macro(_populate_VirtualKeyboard_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::VirtualKeyboard PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5VirtualKeyboard_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5VirtualKeyboard_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    set(Qt5VirtualKeyboard_PRIVATE_INCLUDE_DIRS
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.12.6"
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.12.6/QtVirtualKeyboard"
    )
    ...
    foreach(_module_dep ${_Qt5VirtualKeyboard_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.6 ${_Qt5VirtualKeyboard_FIND_VERSION_EXACT}
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "Qt5VirtualKeyboard.dll" "libQt5VirtualKeyboard.a" )



    _populate_VirtualKeyboard_target_properties(DEBUG "Qt5VirtualKeyboardd.dll" "libQt5VirtualKeyboardd.a" )
