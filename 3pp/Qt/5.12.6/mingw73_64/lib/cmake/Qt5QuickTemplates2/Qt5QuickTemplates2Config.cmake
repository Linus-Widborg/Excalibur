...
set(Qt5QuickTemplates2_VERSION_STRING 5.12.6)
...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(Qt5QuickTemplates2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTemplates2_install_prefix}/include/QtQuickTemplates2/5.12.6"
        "${_qt5QuickTemplates2_install_prefix}/include/QtQuickTemplates2/5.12.6/QtQuickTemplates2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTemplates2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.6 ${_Qt5QuickTemplates2_FIND_VERSION_EXACT}
    ...
    _populate_QuickTemplates2_target_properties(RELEASE "Qt5QuickTemplates2.dll" "libQt5QuickTemplates2.a" )



    _populate_QuickTemplates2_target_properties(DEBUG "Qt5QuickTemplates2d.dll" "libQt5QuickTemplates2d.a" )
